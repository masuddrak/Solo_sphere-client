...
const MypostedJobs = () => {
    ...
    const myPostedData = async () => {
        try {
            const { data } = await axios(`${import.meta.env.VITE_API_URL}/mypostedjobs/${user?.email}`)
                        ...
                        <div className='overflow-hidden border border-gray-200  md:rounded-lg'>
                            <table className='min-w-full divide-y divide-gray-200'>
                                ...
                                <tbody className='bg-white divide-y divide-gray-200 '>
                                    {/* handel my posted table data */}
                                    {
                                        mypostedjobs.map(job => <tr key={job._id}>
                               ...
                               text-xs'
                                            ...
                                            <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                                <div className='flex items-center gap-x-6'>
                                                    <button onClick={() => handelDeleteJob(job._id)} className='text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none'>
                                                        <svg
